...
The Swift implementation here and the [Ruby implementation](https://github.com/ZhgChgLi/RubyRangeable) share a 160-op / 86-probe JSON fixture; both produce byte-identical outputs.
